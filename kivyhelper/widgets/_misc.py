...
class TooltipLayout(FloatLayout):
    ...
    def __init__(self, **kwargs):
        """
        A version of FloatLayout with methods and properties that allow
        it to be easily positioned relative to a mouse cursor. Designed
        to be used in tandem with a Widget that has MouseoverBehavior.

        Args:
            **kwargs: Kivy kwargs. Kwargs unique to ToolTipLayout:
                ...
                edge_padding: By default, TooltipLayout will set its
                    ...
                    Window.
        """
        super(TooltipLayout, self).__init__(**kwargs)
